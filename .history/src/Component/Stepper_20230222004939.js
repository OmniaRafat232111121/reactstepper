...
const Stepper = ({steps,currentStep}) => {
  const displaySteps=(
    ...
    <div className='relative flex flex-col items-center text-teal-500'>
          <div className='ro transition duration-200 ease-in-out rounded-md border-2 border-gray-300 h-12 w-20 flex items-center justify-center py-3'>{/* Display number*/ }
          1 {/* Display number*/ }
          </div>
